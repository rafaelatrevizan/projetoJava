...
public class Pacote_Page extends Base_Page {
	private Faker faker = new Faker();
	// private String hotelllllll;

	public Pacote_Page(WebDriver nav) {
		super(nav);
		// TODO Auto-generated constructor stub
	}

	public Pacote_Page pesquisarHotel(String nomeHotel) {
	...
	public Pacote_Page descricao(String descricao) {
		nav.findElement(By.id("idDsTarifa")).sendKeys(descricao);
		return this;
	}
	
	public Pacote_Page selectFornecedor() {
	...
	public Pacote_Page selectDataVenda(String dataVendaInicio, String dataVendaFim) {
	...
	public Pacote_Page abaTarifario() {
	...
	public Pacote_Page infoTarifario(String nometarifario) {
		nav.findElement(By.id("idNmTarifa")).sendKeys(nometarifario);
		return this;
	}

	public Pacote_Page tabela() {
	...
	public Pacote_Page tarifario_publicacao(String dataInicioPub, String dataFimPub) {
	...
	public Pacote_Page tarifario_tarifa() {
	...
	public Pacote_Page tarifario_tarifa_regime() {
	...
	public Pacote_Page tarifario_tarifa_valores(String valorInd, String valorAdc) {
	...
	public Pacote_Page tarifario_tarifario_salvar() {
		nav.findElement(By.xpath("//form[@id = \"frmTarifaUhEdit\"]/div/div/button")).click();		
		return this;
	}
	
	public Pacote_Page tarifario_publicar() {
		try {Thread.sleep(1000);} catch (InterruptedException ex) {}
